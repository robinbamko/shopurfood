<?php
	...
	class Controller extends BaseController
	{
		...
		{	
			...
			define('ANDR_FIREBASE_API_KEY_CUS', 'AAAA1IIKMLQ:APA91bFAWnpcfabxASYSzoR-tpqkgcBmufJgiihXDYAMvPNTZSKH5Z3NfOShEUWNVEakoa74ThaRs84xl_xj-na25If_TkvIomkBgPo0XVS5TucsjpHGJb0gdIKviWWOU2xfL5yqMfv3');
			...
			define('IOS_FIREBASE_API_KEY_DEL', 'AAAA1IIKMLQ:APA91bFAWnpcfabxASYSzoR-tpqkgcBmufJgiihXDYAMvPNTZSKH5Z3NfOShEUWNVEakoa74ThaRs84xl_xj-na25If_TkvIomkBgPo0XVS5TucsjpHGJb0gdIKviWWOU2xfL5yqMfv3');
			define('ANDR_FIREBASE_API_KEY_MER', 'AAAA1IIKMLQ:APA91bFAWnpcfabxASYSzoR-tpqkgcBmufJgiihXDYAMvPNTZSKH5Z3NfOShEUWNVEakoa74ThaRs84xl_xj-na25If_TkvIomkBgPo0XVS5TucsjpHGJb0gdIKviWWOU2xfL5yqMfv3');
			define('IOS_FIREBASE_API_KEY_MER', 'AAAA1IIKMLQ:APA91bFAWnpcfabxASYSzoR-tpqkgcBmufJgiihXDYAMvPNTZSKH5Z3NfOShEUWNVEakoa74ThaRs84xl_xj-na25If_TkvIomkBgPo0XVS5TucsjpHGJb0gdIKviWWOU2xfL5yqMfv3');
		}
    	...
    	public function setAdminLanguage()
    	{
			...
			//print_r($query); exit;
			$total_notifyCount = $cus_notifyCount+$mer_notifyCount+$pdt_notifyCount+$item_notifyCount + $pay_request_notifyCount+$ordernotifyCount;

...
$PayPalApiUsername 		= 'marimuthu-facilitator_api1.ideazglobal.com'; //PayPal API Username
$PayPalApiPassword 		= '1370416487'; //Paypal API password
$PayPalApiSignature 	= 'AFcWxV21C7fd0v3bYYYRCpSSRl31AmvrOChkLGIT88QMkAm.ciNRVbyD'; //Paypal API Signature
$PayPalCurrencyCode 	= 'USD'; //Paypal Currency Code
$PayPalReturnURL 		= 'http://localhost/paypal_cart/paypal-express-checkout/process.php'; //Point to process.php page
$PayPalCancelURL 		= 'http://localhost/paypal_cart/paypal-express-checkout/cancel_url.html'; //Cancel URL if user clicks cancel

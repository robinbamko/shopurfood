...
(function (factory) {
  ...
  $.fn.extend({
	...
	$.getScript(mydir+"summernote-ext-fontstyle.js");
/*$.getScript('../public/admin/assets/scripts/summernote-ext-fontstyle.js', function()
{
	console.log('loaded');    // script is now loaded and executed.
    // put your dependent JS here.
});
	var imported = document.createElement('script');
	imported.src = '../public/admin/assets/scripts/summernote-ext-fontstyle.js';
	//document.footer.appendChild(imported);

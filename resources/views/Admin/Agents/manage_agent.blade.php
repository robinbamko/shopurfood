                            ...
                            <div class="location panel">
                                ...
                                <div class="panel-body" id="location_table">
                                    ...
                                    <div class="top-button top-btn-full" style="position:relative">
										...
										@if((isset($Agent) && is_array($Agent)) && in_array('3', $Agent) || $allPrev == '1')
									   ...
									   <a href="{{url('export_agent_admin/csv')}}">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example" style="text-align:center">
                                        ...
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
                                            <td><input type="text" id="agentName_search" class="form-control col-md-12" style="width:100%" placeholder="{{ __(Session::get('admin_lang_file').'.ADMIN_TXT_SEARCH') }}"/></td>
                                            ...
                                            <td><input type="text" id="agentPhone_search" class="form-control col-md-12" style="width:100%" placeholder="{{ __(Session::get('admin_lang_file').'.ADMIN_TXT_SEARCH') }}"/></td>
                                            <td>&nbsp;</td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                {{(Lang::has(Session::get('admin_lang_file').'.ADMIN_AGENT_EMAIL')) ? trans(Session::get('admin_lang_file').'.ADMIN_AGENT_EMAIL') : trans($ADMIN_OUR_LANGUAGE.'.ADMIN_AGENT_EMAIL')}}
                                            </th>
                                            <th>
                                                {{(Lang::has(Session::get('admin_lang_file').'.ADMIN_AGENT_PHONE')) ? trans(Session::get('admin_lang_file').'.ADMIN_AGENT_PHONE') : trans($ADMIN_OUR_LANGUAGE.'.ADMIN_AGENT_PHONE')}}
                                            </th>
                                            <th>
    ...
    <script type="text/javascript">
        ...
        function change_status(val,got_status)
        {
            ...
            $.ajax({
                ...
                type:'get',
                url :"<?php echo url("multi_agent_block_admin"); ?>",
                beforeSend: function() {
                    $("#loading-image").show();
                },

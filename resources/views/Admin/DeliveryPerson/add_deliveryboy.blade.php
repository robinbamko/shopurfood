							...
							<div class="box-body spaced" style="padding:20px">
								<div id="location_form" class="panel-body">
									...
									<div class="form-group">
										{!! Form::label('', (Lang::has(Session::get('admin_lang_file').'.ADMIN_AGENT_NAME')) ? trans(Session::get('admin_lang_file').'.ADMIN_AGENT_NAME') : trans($ADMIN_OUR_LANGUAGE.'.ADMIN_AGENT_NAME'),['class' => 'control-label col-sm-2 require']) !!} 
										<div class="col-sm-6">
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
												...
												{!! Form::text('deliver_password',$getvendor->deliver_decrypt_password,['class'=>'form-control','placeholder' => (Lang::has(Session::get('admin_lang_file').'.ADMIN_PASSWORD')) ? trans(Session::get('admin_lang_file').'.ADMIN_PASSWORD') : trans($ADMIN_OUR_LANGUAGE.'.ADMIN_PASSWORD'),'id' => 'deliver_password','maxlength' => '100','readonly']) !!}
								...
								<div class="row">
									<div class="form-group">
										...
										@endif
										@php $url = url('manage-deliveryboy-admin'); @endphp
...
<script>
	...
	$("#profile_form").validate({
		...
		messages: {
			deliver_agent_id : "{{(Lang::has(Session::get('admin_lang_file').'.ADMIN_SEL_AGENT')) ? trans(Session::get('admin_lang_file').'.ADMIN_SEL_AGENT') : trans($ADMIN_OUR_LANGUAGE.'.ADMIN_SEL_AGENT')}}",

                            ...
                            <div class="location panel">
                                ...
                                <div class="box-body spaced">
                                    <div id="location_form" class="collapse @php  if(isset($id)){ echo 'in';} @endphp panel-body">
                                        ...
                                        <div class="row-fluid well">
                                            @if(isset($id) && empty($cate_detail) === false)
                                                {!! Form::open(['method' => 'post','class' => 'form-auth-small','url' => 'update-product-category','id'=>'validate_form']) !!}
                                                {!! Form::hidden('category_id',$cate_id)!!}
                                            @else
                                                {!! Form::open(['method' => 'post','class' => 'form-auth-small','url' => 'add-product-category','id'=>'validate_form']) !!}
                                            @endif
                                            ...
                                            <div class="panel-heading col-md-offset-3">
                                                ...
                                                @if(isset($id))
                                                    <input type="button" value="Cancel" class="btn btn-warning" onclick="javascript:window.location.href='<?php echo url('manage-product-category'); ?>'">
                                                @else
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                {!! Form::open(['method' => 'post','url' => 'import_product_category','enctype' =>'multipart/form-data','onsubmit'=>'return importValidate();'])!!}
                                                <div class="row">
                                                ...
                                                {!! Form::close()!!}
                                                <a href="{{url('download_product_category/csv/sample_file')}}">{{(Lang::has(Session::get('admin_lang_file').'.ADMIN_DWNLD_SAMPLE')) ? trans(Session::get('admin_lang_file').'.ADMIN_DWNLD_SAMPLE') : trans($ADMIN_OUR_LANGUAGE.'.ADMIN_DWNLD_SAMPLE')}}</a>
                                                <br />
                                ...
                                <div class="panel-body" id="location_table" >
                                    ...
                                    <div class="top-button top-btn-full" style="position:relative">
                                        ...
                                        <a href="{{url('download_product_category/csv')}}">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example" style="text-align:center">
                                        ...
                                        <tr>
                                            ...
                                            <th style="text-align:center" sorting_no_need>
...
@section('script')
    <script>
        ...
        function change() {
            ...
            var add = "{{trans(Session::get('admin_lang_file').'.ADMIN_ADD_PRO_CATE')}}";
        ...
        function bulk_function(gotVal,gotStatus){
            $.ajax({
                ...
                data:{'val':gotVal,'status': gotStatus,'type' : 'product'},
 ...
 /*--------block product category,subcategory and products start -------*/
  ...
  if(confirm){ 
   var main_cat_id = $('#cat_blkId').val();  
    $.ajax({
          ...
          url: "{{ url('ajax_change_productCat_status') }}",
          type: 'POST',
...
/*--------block product category,subcategory and products end ---------*/

/*--------Unblock product category,subcategory and products start ---------*/
...
/*--------Unblock product category,subcategory and products start ---------*/
        ...
        $(document).ready(function () {
            ...
            table = $('#dataTables-example').DataTable({
                ...
                "searching":false,
                "ajax":{
                    "url": "{{ url('product-category_list_ajax') }}",
                    "dataType": "json",
                    "type": "POST",
        ...
        function new_change()
        {
            location.href='{{url('manage-product-category?addnow=1')}}';
        }

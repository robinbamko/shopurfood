					...
					<div class="container right-container">
						...
						<div class="col-md-12">
							<div class="location panel">
								...
								{!! Form::open(['method' => 'any','url'=>'download_delboy_transaction','id'=>'demo-form2','class'=>'form-horizontal form-label-left','data-parsley-validate']) !!}
									...
									<div id="location_form" class="panel-body">
										<div class="">
											<div class="form-group">
												...
												<div class="col-sm-6">
													@if(count($delboy_list) > 0)

														{{ Form::select('deliver_id[]',$delboy_list,'',['class' => 'form-control select2' , 'style' => 'width:100%','id' => 'deliver_id','multiple'=>'multiple'] ) }}
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													...
													{{ Form::button((Lang::has(Session::get('admin_lang_file').'.ADMIN_RESET')) ? trans(Session::get('admin_lang_file').'.ADMIN_RESET') : trans($ADMIN_OUR_LANGUAGE.'.ADMIN_RESET'),array('class'=>'btn btn-info','onclick'=>'javascript:window.location.href="'.url('delboy-transaction-report').'";')) }}
												</div>
											</div>

					...
					<div class="container right-container">
						...
						<div class="col-md-12">
							<div class="location panel">
								...
								{!! Form::open(['method' => 'any','url'=>'download_mer_transaction','id'=>'demo-form2','class'=>'form-horizontal form-label-left','data-parsley-validate']) !!}
										...
										<div class="">
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													...
													{{ Form::button((Lang::has(Session::get('admin_lang_file').'.ADMIN_RESET')) ? trans(Session::get('admin_lang_file').'.ADMIN_RESET') : trans($ADMIN_OUR_LANGUAGE.'.ADMIN_RESET'),array('class'=>'btn btn-info','onclick'=>'javascript:window.location.href="'.url('merchant-transaction-report').'";')) }}
												</div>
											</div>

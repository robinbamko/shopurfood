					...
					<div class="container right-container">
						...
						<div class="col-md-12">
							<div class="location panel">
								...
								{!! Form::open(['method' => 'any','url'=>'download_order_rpt','id'=>'demo-form2','class'=>'form-horizontal form-label-left','data-parsley-validate','autocomplete'=>"off"]) !!}
										...
										<div class="">
											...
											<div class="form-group">
												...
												<div class="col-md-4 col-sm-4">
													{!! Form::text('from_date','',['class'=>'form-control','placeholder' => 'MM/DD/YYYY','id' => 'startDatePicker']) !!}
												</div>
												...
												<div class="col-md-4 col-sm-4">
													{!! Form::text('to_date','',['class'=>'form-control','placeholder' => 'MM/DD/YYYY','id' => 'endDatePicker']) !!}
												</div>
											</div> 
											<?php
											...
											<div class="form-group">
												<label class="control-label col-sm-2" for="email">{{(Lang::has(Session::get('admin_lang_file').'.ADMIN_DELBOY')) ? trans(Session::get('admin_lang_file').'.ADMIN_DELBOY') : trans($ADMIN_OUR_LANGUAGE.'.ADMIN_DELBOY')}} :</label>

												<div class="col-sm-6">
													@if(count($delBoyList) > 0)

														{{ Form::select('deliver_id[]',$delBoyList,'',['class' => 'form-control select2' , 'style' => 'width:100%','id' => 'deliver_id','multiple'=>'multiple'] ) }}
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													...
													{{ Form::button((Lang::has(Session::get('admin_lang_file').'.ADMIN_RESET')) ? trans(Session::get('admin_lang_file').'.ADMIN_RESET') : trans($ADMIN_OUR_LANGUAGE.'.ADMIN_RESET'),array('class'=>'btn btn-info','onclick'=>'javascript:window.location.href="'.url('manage-order-report').'";')) }}
												</div>
											</div>

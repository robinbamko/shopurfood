							...
							<div class="location panel">
								...
								<div class="well-inline" style="margin:2%;">
									<div class="cal-search-filter">
										{!! Form::open(['method' => 'post','class' => 'form-horizontal','url' => url('admin-delivery-boy-map'),'id'=>'validate_form']) !!}
											...
											<div class="modal-body">
												<div class="form-group">
													<label class="control-label col-sm-2">{{(Lang::has(Session::get('admin_lang_file').'.ADMIN_DELBOY_NAME')) ? trans(Session::get('admin_lang_file').'.ADMIN_DELBOY_NAME') : trans($ADMIN_OUR_LANGUAGE.'.ADMIN_DELBOY_NAME')}} :</label>
													...
													{{--{!! Form::text('del_boy_name','',['class'=>'form-control','placeholder' => (Lang::has(Session::get('admin_lang_file').'.ADMIN_DELBOY_NAME')) ? trans(Session::get('admin_lang_file').'.ADMIN_DELBOY_NAME') : trans($ADMIN_OUR_LANGUAGE.'.ADMIN_DELBOY_NAME'),'id' => 'del_boy_name']) !!}--}}

													</div>
													
													<label class="control-label col-sm-2">{{(Lang::has(Session::get('admin_lang_file').'.ADMIN_MOBILENO')) ? trans(Session::get('admin_lang_file').'.ADMIN_MOBILENO') : trans($ADMIN_OUR_LANGUAGE.'.ADMIN_MOBILENO')}} :</label>
												  ...
												  <div class="form-group">
													<label class="control-label col-sm-2">{{(Lang::has(Session::get('admin_lang_file').'.ADMIN_LOCATION')) ? trans(Session::get('admin_lang_file').'.ADMIN_LOCATION') : trans($ADMIN_OUR_LANGUAGE.'.ADMIN_LOCATION')}} :</label>

													<div class="col-md-8">
														{!! Form::text('del_boy_location',$del_boy_location,['class'=>'form-control','placeholder' => (Lang::has(Session::get('admin_lang_file').'.ADMIN_LOCATION')) ? trans(Session::get('admin_lang_file').'.ADMIN_LOCATION') : trans($ADMIN_OUR_LANGUAGE.'.ADMIN_LOCATION'),'id' => 'del_boy_location']) !!}
													...
													<div class="col-md-4">
														...
														@php 
															...
															'1'=>(Lang::has(Session::get('admin_lang_file').'.ADMIN_AVAILABLE')) ? trans(Session::get('admin_lang_file').'.ADMIN_AVAILABLE') : trans($ADMIN_OUR_LANGUAGE.'.ADMIN_AVAILABLE'),
															'2'=>(Lang::has(Session::get('admin_lang_file').'.ADMIN_BUSY')) ? trans(Session::get('admin_lang_file').'.ADMIN_BUSY') : trans($ADMIN_OUR_LANGUAGE.'.ADMIN_BUSY'),
															'3'=>(Lang::has(Session::get('admin_lang_file').'.ADMIN_UNAVAILABLE')) ? trans(Session::get('admin_lang_file').'.ADMIN_UNAVAILABLE') : trans($ADMIN_OUR_LANGUAGE.'.ADMIN_UNAVAILABLE'),
												  ...
												  <div class="clearfix"></div>
													<div class="col-md-offset-2">
														...
														<a href="{{url('admin-delivery-boy-map')}}"><button type="button" name="reset" class="btn btn-default"> @lang(Session::get('admin_lang_file').'.ADMIN_RESET') </button></a>
								...
								<div id="map" style="height:428px;margin:2%;"></div>
									...
									@if(Session::get('admin_lang_code') == '' || Session::get('admin_lang_code') == 'en')
										@php $map_lang = 'en'; @endphp
									@else
										@php $map_lang = Session::get('admin_lang_code'); @endphp
									@endif
											...
											@if(count($delivery_boy_details) > 0)
												@foreach($delivery_boy_details as $details)
													...
													@if($details->deliver_avail_status == 1)
															@php $status = (Lang::has(Session::get('admin_lang_file').'.ADMIN_AVAILABLE')) ? trans(Session::get('admin_lang_file').'.ADMIN_AVAILABLE') : trans($ADMIN_OUR_LANGUAGE.'.ADMIN_AVAILABLE'); @endphp
													@elseif($details->deliver_avail_status == 2)	
															@php $status = (Lang::has(Session::get('admin_lang_file').'.ADMIN_UNAVAILABLE')) ? trans(Session::get('admin_lang_file').'.ADMIN_UNAVAILABLE') : trans($ADMIN_OUR_LANGUAGE.'.ADMIN_UNAVAILABLE'); @endphp
													@elseif($details->deliver_avail_status == 3)
															@php $status = (Lang::has(Session::get('admin_lang_file').'.ADMIN_BUSY')) ? trans(Session::get('admin_lang_file').'.ADMIN_BUSY') : trans($ADMIN_OUR_LANGUAGE.'.ADMIN_BUSY'); @endphp
													@endif
													
														["<b><span style='color:green;font-weight:900;'><i class='fa fa-male'></i>&nbsp;{{$status}}</span></b> <br/><b>{{(Lang::has(Session::get('admin_lang_file').'.ADMIN_DELBOY_NAME')) ? trans(Session::get('admin_lang_file').'.ADMIN_DELBOY_NAME') : trans($ADMIN_OUR_LANGUAGE.'.ADMIN_DELBOY_NAME')}}:</b>&nbsp;{{$details->deliver_fname}} {{$details->deliver_lname}},<br/><b>{{(Lang::has(Session::get('admin_lang_file').'.ADMIN_ADDRESS')) ? trans(Session::get('admin_lang_file').'.ADMIN_ADDRESS') : trans($ADMIN_OUR_LANGUAGE.'.ADMIN_ADDRESS')}}:</b>&nbsp;{{$details->deliver_location}},<br/><b>{{(Lang::has(Session::get('admin_lang_file').'.ADMIN_PHONE')) ? trans(Session::get('admin_lang_file').'.ADMIN_PHONE') : trans($ADMIN_OUR_LANGUAGE.'.ADMIN_PHONE')}}:</b>&nbsp;{{$details->deliver_phone1}},{{$details->deliver_phone2}}&nbsp;",{{$details->deliver_latitude}},{{$details->deliver_longitude}}, 4],

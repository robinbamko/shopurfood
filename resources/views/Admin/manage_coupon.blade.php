								...
								<table class="table table-striped table-bordered table-hover" id="dataTables-example" style="text-align:center">
									...
									<tbody>
										...
										<tr>
											...
											<td>{{$i}}</td>
											<td>{{ ucfirst($details->coupon_name) }}</td>
											<td>{{ $details->coupon_code }}</td>
											<td>{{ $details->coupon_start_date }}</td>
											<td>{{ $details->coupon_end_date }}</td>
										    <td>
													<a href="{!! url('edit-coupon').'/'.base64_encode($details->id) !!}"><i class="fa fa-pencil tooltip-demo" aria-hidden="true" title="Edit"></i></a>
												</td>
												<td>
													@if($details->coupon_status == 1)  {{--0-block, 1- active --}}
													<a href="{!! url('coupon_status').'/'.$details->id.'/0' !!}"><i class="fa fa-check tooltip-demo" aria-hidden="true" title="Click to Block"></i></a>
													@else
													<a href="{!! url('coupon_status').'/'.$details->id.'/1' !!}"><i class="fa fa-ban tooltip-demo" aria-hidden="true" title="Click to Unblock" onClick="change_status($details->id)"></i></a>
													@endif
												</td>
												<td>

													<a href= "{!! url('coupon_status').'/'.$details->id.'/2' !!}" title="delete" class="tooltip-demo">

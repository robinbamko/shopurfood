					...
					<div class="col-md-12">
						<div class="location panel">
							<div class="panel-heading p__title">
								{{$pagetitle}}
								<a href="{{url('/deliveryboy-commission-tracking')}}" class="btn btn-success pull-right">{{ (Lang::has(Session::get('DelMgr_lang_file').'.DELMGR_BACK')) ? trans(Session::get('DelMgr_lang_file').'.DELMGR_BACK') : trans($DELMGR_OUR_LANGUAGE.'.DELMGR_BACK') }}</a>
							</div>

							...
							<div class="panel-body" id="location_table" >
								...
								<div style="margin: 7px 23px;">
									<div class="cal-search-filter">
										{!! Form::open(['method' => 'post','class' => 'form-horizontal','url' => url('delivery-manage-orders1'),'id'=>'validate_form']) !!}
											<div class="row">
												<br>
												...
												<div class="form-group">
													...
													<div class="col-sm-2">
														<a href="{{url('delivery-manage-orders1')}}"><button type="button" name="reset" class="btn btn-block btn-info"> @lang(Session::get('DelMgr_lang_file').'.DEL_RESET') </button></a>
													</div>
												</div>
								...
								<table class="table table-striped table-bordered table-hover" id="dataTables-example" style="text-align:center">
									<thead>
										<tr>
											...
											<th style="text-align:center">
												{{(Lang::has(Session::get('DelMgr_lang_file').'.ADMIN_DELBOY_ASSIGNED')) ? trans(Session::get('DelMgr_lang_file').'.ADMIN_DELBOY_ASSIGNED') : trans($DELMGR_OUR_LANGUAGE.'.ADMIN_DELBOY_ASSIGNED')}}
											</th>
											<th style="text-align:center">
									...
									<tbody>
										...
										<tr>
											...
											<td width="10%">{{ ucfirst($details->deliver_fname).' '.$details->deliver_lname}}<br>{{'('.$details->deliver_email.')'}}</td>

				...
				<table style="padding:10px;width:100%;">
					<tr>
						<td align="center">
							...
							@endif							
							@endif
							<img src="{{$path}}" alt="@lang(Session::get('front_lang_file').'.UR_DETAILS')" class="img-responsive logo"  width="100">
						</td>						
					</tr>
				</table>
				</td>
			...
			<tr>
				<td>
					<table style="width:100%;background:url({{url('').'/resources/views/email/'}}bg.jpg); padding:50px 20px;">
						<tr>
							<td colspan="1" style="text-align:center; font-family:cursive; font-size:35px; padding-bottom: 20px;  color: #fff;">{{ (Lang::has(Session::get('front_lang_file').'.FRONT_CUSTOMER_CONTACT_DETAILS')!= '') ? trans(Session::get('front_lang_file').'.FRONT_CUSTOMER_CONTACT_DETAILS') : trans($FRONT_LANGUAGE.'.FRONT_CUSTOMER_CONTACT_DETAILS') }}</td>							
						</tr>
					</table>
				</td>
			</tr>

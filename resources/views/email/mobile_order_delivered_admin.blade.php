					...
					<table style="font-family:sans-serif; font-size:14px; width:100%; padding:20px 20px;"  align="center">
						<tr>
							<td colspan="2" style="border-bottom: 2px solid #69c332; padding-bottom:5px; font-family:sans-serif; font-size:22px;color: #69c332;">
								@lang($lang.'_mob_lang.API_DELI_ADDR')
							</td>
						</tr>
						
						@if(empty($customer_details)===false)
							<tr><td style="padding:5px 0;">{{$customer_details->ord_shipping_cus_name}}</td></tr>
							<tr><td style="padding:5px 0;">{{$customer_details->ord_shipping_address1}}</td></tr>
							<tr><td style="padding:5px 0;">{{$customer_details->ord_shipping_address}}</td></tr>
							<tr><td style="padding:5px 0;">{{$customer_details->ord_shipping_mobile}}</td></tr>
							<tr><td style="padding:5px 0;">{{$customer_details->ord_shipping_mobile1}}</td></tr>
							<tr><td style="padding:5px 0;">{{$customer_details->order_ship_mail}}</td></tr>
						@endif
					</table>
				</td>
			</tr>
			...
			<tr>
				<td>
					<table style="font-family:sans-serif; font-size:14px; width:100%; padding:0px 20px 10px; border-bottom: 1px solid #ddd;"  align="center">
						<tr>
							<td colspan="2" style="border-bottom: 2px solid #69c332; padding-bottom:5px; font-family:sans-serif; font-size:22px;color: #69c332;">@lang($lang.'_mob_lang.API_ITEMS_DELIVER')</td>
						</tr>
					...
					<!-- 	@php 
						$ch = get_choice_name_defaultLang($array->choice_id);
						 @endphp -->

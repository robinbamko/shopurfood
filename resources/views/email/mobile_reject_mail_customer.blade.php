					...
					<table style="font-family:sans-serif; font-size:14px; width:100%; padding:20px 20px;" align="center">
						<tbody>
							...
							<tr><td style="padding:5px 0;">
								<p>@lang($lang.'.API_ORDER_REJECT_SUMMARY')&nbsp;{{$SITENAME}}@lang($lang.'.API_ORDER_REJECT_SUMMARY1').</p>
								<p>@lang($lang.'.API_ORDER_REJECT_SUMMARY2')</p></td></tr>

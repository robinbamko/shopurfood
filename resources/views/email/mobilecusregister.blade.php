			...
			<tr>
				<td>
					<table style="width:100%;background:url({{url('').'/resources/views/email/'}}bg.jpg); padding:50px 20px;">
						...
						<tr>
							<td align="center"><a href="{{url('')}}"><button type="button" style="background:#e48743; border:0; padding:10px 20px; color:#fff; font-size:15px;">@lang($lang.'.API_LOGIN_YOUR_ACCOUNT')</button></a></td>
						</tr>
					</table>
				</td>
			</tr>

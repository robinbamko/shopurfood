<html>
	<body style="margin: 0; padding: 0;">
		...
		<table cellpadding="0" cellspacing="0" width="600" align="center" style="border:1px solid #ddd;">
					...
					<table style="width:100%;background:url('{{url('public/images/order_image.jpg')}}')no-repeat; padding:56px 20px;">
						<tr>
							<td colspan="1" style="text-align:center; font-family:cursive; font-size:35px; padding-bottom: 20px;  color: #fff;">
								@lang(Session::get('mer_lang_file').'.FRONT_ORDER_CANCELLED_TOADMIN')
							</td>							
						</tr>
						<tr>
							<td colspan="1" style="text-align:center; font-family:sans-serif; font-size:17px; padding-bottom: 20px;  color: #fff; line-height: 25px;">
								@lang(Session::get('mer_lang_file').'.FRONT_ORDER_CANCELLED_SUMMARY')
							</td>							
						</tr>
						<tr>
							<td colspan="1" style="text-align:center; font-family:sans-serif; font-size:17px; padding-bottom: 20px;  color: #fff; line-height: 25px;">
			...
			@if($order_details[0]->ord_self_pickup == 0)
			<tr>
				<td>
					<table style="font-family:sans-serif; font-size:14px; width:100%; padding:20px 20px;"  align="center">
						<tr>
							<td colspan="2" style="border-bottom: 2px solid #69c332; padding-bottom:5px; font-family:sans-serif; font-size:22px;color: #69c332;">
								@lang(Session::get('mer_lang_file').'.ADMIN_CUSTOMER_DETAILS')
							</td>
						</tr>
								<tr><td style="padding:5px 0;">{{$order_details[0]->ord_shipping_cus_name}}</td></tr>
								<tr><td style="padding:5px 0;">{{$order_details[0]->ord_shipping_address1}}</td></tr>
								<tr><td style="padding:5px 0;">{{$order_details[0]->ord_shipping_address}}</td></tr>
								<tr><td style="padding:5px 0;">{{$order_details[0]->ord_shipping_mobile}}</td></tr>
								<tr><td style="padding:5px 0;">{{$order_details[0]->ord_shipping_mobile1}}</td></tr>
								<tr><td style="padding:5px 0;">{{$order_details[0]->order_ship_mail}}</td></tr>

							...
							<div class="location panel">
								...
								<div class="panel-body" id="location_table" >
									...
									<div class="top-button top-btn-full" style="position: relative;">
										...
										<a href="{{url('mer_download_item_list/csv')}}">
									...
									<table class="table table-striped table-bordered table-hover" id="dataTables-example" style="text-align:center">
										<thead>
										<tr>
											<td>&nbsp;<input type="hidden" id="pdtStore_search"/></td>
										...
										<tr>
											<th  style="text-align:center" class="sorting_no_need">{!! Form::checkbox('chk_none[]','','',['id' => 'check_all','class'=>'checkboxclass','onchange' =>'checkAll(this)'])!!}</th>

											<th style="text-align:center">
												{{(Lang::has(Session::get('mer_lang_file').'.ADMIN_ITEM_CODE')) ? trans(Session::get('mer_lang_file').'.ADMIN_ITEM_CODE') : trans($MER_OUR_LANGUAGE.'.ADMIN_ITEM_CODE')}}
											</th>
											<th style="text-align:center">
												{{(Lang::has(Session::get('mer_lang_file').'.ADMIN_ITEM_NAME')) ? trans(Session::get('mer_lang_file').'.ADMIN_ITEM_NAME') : trans($MER_OUR_LANGUAGE.'.ADMIN_ITEM_NAME')}}
											</th>
											<th style="text-align:center">
											...
											<th style="text-align:center">
												{{(Lang::has(Session::get('mer_lang_file').'.ADMIN_ITEM_IMAGE')) ? trans(Session::get('mer_lang_file').'.ADMIN_ITEM_IMAGE') : trans($MER_OUR_LANGUAGE.'.ADMIN_ITEM_IMAGE')}}
											</th>
											<th style="text-align:center">

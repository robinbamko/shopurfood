					...
					<div class="col-md-6">
						<div class="location panel">
							...
							<!-- {{-- Display error message--}} -->
							    ...
							    <a href="{{url('mer_delete_zip/'.$errors->first('filename') )}}">Click to delete that ZIP File</a>
							    @endif
							    @endif
							...
							<div class="box-body spaced" style="padding:20px">
								<div id="location_form" class="collapse in panel-body">
									...
									<div class="row-fluid well">
										...
										{!! Form::open(['method' => 'post','class' => 'form-auth-small','url' => 'mer_product_image_bulk_upload_submit','enctype'=>'multipart/form-data','id'=>'zip_form']) !!}
									...
									<div class="row-fluid well">
										...
										{!! Form::open(['method' => 'post','class' => 'form-auth-small','url' => 'mer_product_bulk_upload_submit','enctype'=>'multipart/form-data','id'=>'csv_form']) !!}
						...
						<div class="col-md-6">
							<div class="location panel">
								...
								<div class="box-body spaced" style="padding:20px">
									<a href="{{ url('public/sample-csv/product-test.csv')}}">@lang(Session::get('mer_lang_file').'.ADMIN_DWLD')</a>

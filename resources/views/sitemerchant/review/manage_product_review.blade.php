						...
						<div class="location panel">
							...
							<div class="panel-body" id="location_table" >
								...
								{!! Form::button((Lang::has(Session::get('mer_lang_file').'.ADMIN_DELETE')) ? trans(Session::get('mer_lang_file').'.ADMIN_DELETE') : trans($MER_OUR_LANGUAGE.'.ADMIN_DELETE'),['id' => 'delete_value','class' => 'btn btn-danger'])!!}
									...
									<thead>
										<tr>
											<th  style="text-align:center">{!! Form::checkbox('chk_none[]','','',['id' => 'check_all','onchange' =>'checkAll(this)'])!!}</th>
											...
											@if($current_route =="mer-manage-product-review")
											<th style="text-align:center">
											...
											@elseif($current_route =="mer-manage-item-review")
											<th style="text-align:center">
											...
											<th style="text-align:center">
												{{(Lang::has(Session::get('mer_lang_file').'.ADMIN_RESTAURANT_NAME')) ? trans(Session::get('mer_lang_file').'.ADMIN_RESTAURANT_NAME') : trans($MER_OUR_LANGUAGE.'.ADMIN_RESTAURANT_NAME')}}
											</th>
											@endif
											<th style="text-align:center">

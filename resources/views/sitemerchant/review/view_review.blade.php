										...
										<div class="row-fluid well">
											@if(isset($id) && empty($detail) === false)
												...
												<span class="panel-title">
													{{(Lang::has(Session::get('mer_lang_file').'.ADMIN_COMMENT_REVIEW')) ? trans(Session::get('mer_lang_file').'.ADMIN_COMMENT_REVIEW') : trans($MER_OUR_LANGUAGE.'.ADMIN_COMMENT_REVIEW')}}
												</span>
													</div>
													<div class="col-md-8">
												...
												<div class="row panel-heading">
													<div class="col-md-4">
												<span class="panel-title">
													{{(Lang::has(Session::get('mer_lang_file').'.ADMIN_RATING_REVIEW')) ? trans(Session::get('mer_lang_file').'.ADMIN_RATING_REVIEW') : trans($MER_OUR_LANGUAGE.'.ADMIN_RATING_REVIEW')}}
												</span>
													</div>
													<div class="col-md-8">

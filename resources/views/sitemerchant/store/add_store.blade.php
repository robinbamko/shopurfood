					...
					<div class="col-md-12">
						<div class="location panel">
							<div class="panel-heading p__title">
								{{$pagetitle}}
								<span style="float:right;color:#6f3938f2;font-size:18px">{{ ($getstore->st_status != '') ? (($getstore->st_status == '1') ? "Store Status : Active" : "Store Status : block" ) : '' }}</span>
							</div>
							...
							<div class="box-body spaced box-body-padding" >
								<div id="location_form" class="panel-body">
									<div class="row-fluid well">
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												@if($getstore->st_category == '')  {{-- no category selected --}}
													{!! Form::radio('select','list','',['id' => 'select','onClick' => 'show("list")','required'])!!}&nbsp;{!!Form::label('select',(Lang::has(Session::get('mer_lang_file').'.ADMIN_SELECT_DROP')) ? trans(Session::get('mer_lang_file').'.ADMIN_SELECT_DROP') : trans($MER_OUR_LANGUAGE.'.ADMIN_SELECT_DROP'))!!}
													{!! Form::radio('select','text','',['id' => 'custom','onClick' => 'show("text")','required'])!!}&nbsp;{!!Form::label('custom',(Lang::has(Session::get('mer_lang_file').'.ADMIN_CUSTOM')) ? trans(Session::get('mer_lang_file').'.ADMIN_CUSTOM') : trans($MER_OUR_LANGUAGE.'.ADMIN_CUSTOM'))!!}
												@elseif($getstore->st_category != '') {{-- category selected --}}
													@php $category = get_details('gr_category',['cate_id' => $getstore->st_category],'cate_name'); @endphp
													{!! Form::text('cate_name',((empty($category) === false) ? $category->cate_name : ''),['readonly','class' => 'form-control'])!!}
												@endif
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-6">
												<span id="list" style="display:none">
													@if(count($category_list) > 0)
														{{ Form::select('cate_name1',$category_list,$getstore->st_category,['class' => 'form-control' , 'style' => 'width:100%'] ) }}
													@else
												...
												<span id="text" style="display:none">
													@if($getstore->st_category == '')	{{-- category not  selected --}}
										...
										<div class="form-group">
											{!! Form::label('', (Lang::has(Session::get('mer_lang_file').'.ADMIN_ST_NAME')) ? trans(Session::get('mer_lang_file').'.ADMIN_ST_NAME') : trans($MER_OUR_LANGUAGE.'.ADMIN_ST_NAME'),['class' => 'control-label col-sm-2 require blackstarclass']) !!}
											<div class="col-sm-6">
												{!! Form::text('st_name',$getstore->st_store_name,array('required','placeholder'=> (Lang::has(Session::get('mer_lang_file').'.ADMIN_ST_NAME')) ? trans(Session::get('mer_lang_file').'.ADMIN_ST_NAME') : trans($MER_OUR_LANGUAGE.'.ADMIN_ST_NAME'),'class'=>'form-control','maxlength'=>'100','id' => 'st_name')) !!}
											</div>
										</div>
										@if(count($Mer_Active_Language) > 0)
											...
											<div class="form-group">
												<label class="control-label col-sm-2" for="email">{{(Lang::has(Session::get('mer_lang_file').'.ADMIN_ST_NAME')) ? trans(Session::get('mer_lang_file').'.ADMIN_ST_NAME') : trans($MER_OUR_LANGUAGE.'.ADMIN_ST_NAME')}}&nbsp; (In {{$lang->lang_name}}):</label>
												<div class="col-sm-6">
													{!! Form::text('st_name_'.$lang->lang_code.'',$getstore->$name,array('placeholder'=>(Lang::has(Session::get('mer_lang_file').'.ADMIN_ST_NAME')) ? trans(Session::get('mer_lang_file').'.ADMIN_ST_NAME') : trans($MER_OUR_LANGUAGE.'.ADMIN_ST_NAME'),'class'=>'form-control','maxlength'=>'100')) !!}
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												{!! Form::text('min_order_amt',$getstore->st_minimum_order,array('placeholder'=>(Lang::has(Session::get('mer_lang_file').'.ADMIN_MINIMUM_ORDER_COUNT')) ? trans(Session::get('mer_lang_file').'.ADMIN_MINIMUM_ORDER_COUNT') : trans($MER_OUR_LANGUAGE.'.ADMIN_MINIMUM_ORDER_COUNT'),'class'=>'form-control','maxlength'=>'3','id' => 'min_order')) !!}
												
											</div>
										</div>
										
										<div class="form-group">
											<label class="control-label col-sm-2" for="email">{{ (Lang::has(Session::get('mer_lang_file').'.ADMIN_ABOUT_ST')) ? trans(Session::get('mer_lang_file').'.ADMIN_ABOUT_ST') : trans($MER_OUR_LANGUAGE.'.ADMIN_ABOUT_ST')}}* :</label>
											
											<div class="col-sm-6">
												{!! Form::textarea('st_desc',$getstore->st_desc,array('required','placeholder'=> (Lang::has(Session::get('mer_lang_file').'.ADMIN_ABOUT_ST')) ? trans(Session::get('mer_lang_file').'.ADMIN_ABOUT_ST') : trans($MER_OUR_LANGUAGE.'.ADMIN_ABOUT_ST'),'class'=>'form-control summernote','required')) !!}
										...
										@if(count($Mer_Active_Language) > 0)
											...
											<div class="form-group">
												<label class="control-label col-sm-2" for="email">{{(Lang::has(Session::get('mer_lang_file').'.ADMIN_ABOUT_ST')) ? trans(Session::get('mer_lang_file').'.ADMIN_ABOUT_ST') : trans($MER_OUR_LANGUAGE.'.ADMIN_ABOUT_ST')}}&nbsp; (In {{$lang->lang_name}}):</label>
												<div class="col-sm-6">
													{!! Form::textarea('st_desc_'.$lang->lang_code.'',$getstore->$desc,array('placeholder'=>(Lang::has(Session::get('mer_lang_file').'.ADMIN_ABOUT_ST')) ? trans(Session::get('mer_lang_file').'.ADMIN_ABOUT_ST') : trans($MER_OUR_LANGUAGE.'.ADMIN_ABOUT_ST'),'class'=>'form-control summernote')) !!}
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												{!! Form::text('del_time',$getstore->st_delivery_time,array('required','placeholder'=> (Lang::has(Session::get('mer_lang_file').'.ADMIN_DELIVERY_TIME')) ? trans(Session::get('mer_lang_file').'.ADMIN_DELIVERY_TIME') : trans($MER_OUR_LANGUAGE.'.ADMIN_DELIVERY_TIME'),'class'=>'form-control','maxlength'=>'2','id' => 'deli_time')) !!}
										...
										<div class="form-group">
											<label class="control-label col-sm-2" for="email">{{ (Lang::has(Session::get('mer_lang_file').'.ADMIN_DEL_RADIUS')) ? trans(Session::get('mer_lang_file').'.ADMIN_DEL_RADIUS') : trans($MER_OUR_LANGUAGE.'.ADMIN_DEL_RADIUS')}}* :</label>
											
											<div class="col-sm-4">
												{!! Form::text('del_radius',$getstore->st_delivery_radius,array('required','placeholder'=> (Lang::has(Session::get('mer_lang_file').'.ADMIN_DEL_RADIUS')) ? trans(Session::get('mer_lang_file').'.ADMIN_DEL_RADIUS') : trans($MER_OUR_LANGUAGE.'.ADMIN_DEL_RADIUS'),'class'=>'form-control','maxlength'=>'2','id' => 'del_radius','required')) !!}
												@if ($errors->has('del_radius') ) 
												<p class="error-block" style="color:red;">{{ $errors->first('del_radius') }}</p> 
												@endif
											</div>
											<div class="col-sm-2">
												{!! Form::text('',(Lang::has(Session::get('mer_lang_file').'.ADMIN_IN_KM')) ? trans(Session::get('mer_lang_file').'.ADMIN_IN_KM') : trans($MER_OUR_LANGUAGE.'.ADMIN_IN_KM'),['class'=>'form-control','disabled']) !!}
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-sm-2" for="email">{{ (Lang::has(Session::get('mer_lang_file').'.ADMIN_ST_ADDR')) ? trans(Session::get('mer_lang_file').'.ADMIN_ST_ADDR') : trans($MER_OUR_LANGUAGE.'.ADMIN_ST_ADDR')}}* :</label>
											
											<div class="col-sm-6">
												{!! Form::text('st_addr',$getstore->st_address,array('required','placeholder'=> (Lang::has(Session::get('mer_lang_file').'.ADMIN_ST_ADDR_EX')) ? trans(Session::get('mer_lang_file').'.ADMIN_ST_ADDR_EX') : trans($MER_OUR_LANGUAGE.'.ADMIN_ST_ADDR_EX'),'class'=>'form-control','id' => 'us3-address','required')) !!}
										...
										<div class="form-group">
											...
											<label class="control-label col-sm-2" for="email">{{ (Lang::has(Session::get('mer_lang_file').'.ADMIN_ST_LOGO')) ? trans(Session::get('mer_lang_file').'.ADMIN_ST_LOGO') : trans($MER_OUR_LANGUAGE.'.ADMIN_ST_LOGO')}}* :</label>
											<div class="col-sm-6">
												@if($getstore->st_logo != '')
													{{ Form::file('st_logo',array('class' => 'form-control','accept'=>'image/*','id'=>'st_logo','onchange'=>'Upload(this.id,"300","300","500","500");')) }} 
										...
										<div class="form-group">
											...
											<label class="control-label col-sm-2" for="email">{{ (Lang::has(Session::get('mer_lang_file').'.ADMIN_ST_BANNER')) ? trans(Session::get('mer_lang_file').'.ADMIN_ST_BANNER') : trans($MER_OUR_LANGUAGE.'.ADMIN_ST_BANNER')}}* :</label>
											...
											@if($getstore->st_banner != '')
												...
												<div class="col-sm-6">
													...
													@for($i=0;$i<count($banner); $i++)
														...
														{{ Form::file('st_banner[]',array('class' => 'form-control upload_file banner','accept'=>'image/*',"id"=>"st_banner'.$i.'",'onchange'=>'Upload(this.id,"1366","300","1500","500");')) }}
														@php $filename = public_path('images/store/banner/').$banner[$i];  @endphp
														
														@if(file_exists($filename))
															{{ Form::image(url('public/images/store/banner/'.$banner[$i]), 'alt text', array('class' => 'add-store-img','width'=>'150px','height'=>'50px','id' => ' ')) }}
														@else
														...
														@if($i>0)
															{!! Form::button((Lang::has(Session::get('mer_lang_file').'.ADMIN_REMOVE')) ? trans(Session::get('mer_lang_file').'.ADMIN_REMOVE') : trans($MER_OUR_LANGUAGE.'.ADMIN_REMOVE'),['class' =>'btn btn-danger btn-sm','onClick' => "remove_file('$banner[$i]','$getstore->id');",'style' =>'float: right;margin-top: 10px;'])!!}
														@elseif($i == 0)
											...
											<div class="form-group">
												...
												@endif
												@php $url = url('mer-manage-store')@endphp
								...
								<script>
									...
									$('#st_name,#cate_name').bind('keyup blur',function(){ 
										var node = $(this);
								...
								<script>
									...
									$("#validate_form").validate({
										...
										messages: {
											...
											st_desc: "{{(Lang::has(Session::get('mer_lang_file').'.ADMIN_PL_ENTR_ST_DESC')) ? trans(Session::get('mer_lang_file').'.ADMIN_PL_ENTR_ST_DESC') : trans($MER_OUR_LANGUAGE.'.ADMIN_PL_ENTR_ST_DESC')}}",
											...
											st_addr: "{{(Lang::has(Session::get('mer_lang_file').'.ADMIN_PL_STORE_ADDR')) ? trans(Session::get('mer_lang_file').'.ADMIN_PL_STORE_ADDR') : trans($MER_OUR_LANGUAGE.'.ADMIN_PL_STORE_ADDR')}}",
											st_logo: "{{(Lang::has(Session::get('mer_lang_file').'.ADMIN_PL_ENTR_LOGO')) ? trans(Session::get('mer_lang_file').'.ADMIN_PL_ENTR_LOGO') : trans($MER_OUR_LANGUAGE.'.ADMIN_PL_ENTR_LOGO')}}",
											"st_banner[]": "{{(Lang::has(Session::get('mer_lang_file').'.ADMIN_PL_ENTR_BANNER')) ? trans(Session::get('mer_lang_file').'.ADMIN_PL_ENTR_BANNER') : trans($MER_OUR_LANGUAGE.'.ADMIN_PL_ENTR_BANNER')}}",
										}
									});
